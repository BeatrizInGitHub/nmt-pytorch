...
class NETSDataset(object):
    def __init__(self, _config):
        ...
        self.bad_user_set = {'k1_398', 'k1_497', 'k1_681', 'k1_1465',
                             'k1_1637', 'k1_1918', 'k1_4301', 'k1_6424',
                             'k1_6597', 'k1_7649', 'k1_8201', 'k1_8309',
                             'k1_10070', 'k1_10430', 'k1_10606'}
    ...
    def build_word_dict(self, path, update=True):
        ...
        with open(path, 'r', newline='', encoding='utf-8') as f:
            ...
            for k, features in enumerate(calendar_data):
                ...
                # remove bad users
                if user_id in self.bad_user_set:
                    continue
    ...
    def process_data(self, path, update_dict=False):
        ...
        with open(path, 'r', newline='', encoding='utf-8') as f:
            ...
            for k, features in enumerate(calendar_data):
                ...
                target_n_slot = \
                    int(math.ceil(duration / (30 * self.class_div)))
...
class Config(object):
    def __init__(self):
        path_base = './data/k1_k2_20180124_192126'
        ...
        self.preprocess_load_path = './data/dataset_180513.pkl'
